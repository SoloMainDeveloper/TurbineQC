...
class LeadingEdgeWidth : public ITurbineProfileParameter {
public:
    LeadingEdgeWidth(double nominal, double upperTolerance, double lowerTolerance,
...
private:
    const QString _parameterNameTemplate = "%1_LE_Width_P";
    const QString _dimensionNameTemplate = "%1_LE_Thck";
};
