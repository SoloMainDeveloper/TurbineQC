...
ChangeCurveParametersCommand::ChangeCurveParametersCommand(const QString& figureName, bool isVisible,
...
void ChangeCurveParametersCommand::run() {
	const Figure* figure = Project::instance().findFigure(_figureName);

	if (dynamic_cast<const CurveFigure*>(figure)) {
