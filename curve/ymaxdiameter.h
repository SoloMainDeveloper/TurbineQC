...
class YMaxDiameter : public ITurbineProfileParameter {
public:
    YMaxDiameter(double nominal, double upperTolerance, double lowerTolerance,
...
private:
    ...
    const QString _dimensionNameTemplate = "%1_YD";
};
