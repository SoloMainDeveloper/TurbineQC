...
class MaxDiameter : public ITurbineProfileParameter {
public:
    MaxDiameter(double nominal, double upperTolerance, double lowerTolerance,
...
private:
    ...
    const QString _dimensionNameTemplate = "%1 Maximum Diameter";
};
